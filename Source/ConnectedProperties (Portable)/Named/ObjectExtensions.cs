...
namespace Nito.ConnectedProperties.Named
{
    ...
    public static class ObjectExtensions
    {
        ...
        public static IConnectibleProperty<dynamic> GetConnectedPropertyAsObject(this object carrier, string name, bool bypassValidation = false)
        {
            Contract.Requires(carrier != null);
            Contract.Ensures(Contract.Result<IConnectibleProperty<object>>() != null);
        ...
        public static IConnectibleProperty<object> TryGetConnectedPropertyAsObject(this object carrier, string name, bool bypassValidation = false)
        {
            Contract.Requires(carrier != null);
        ...
        /// <returns>The connectible property.</returns>
        /// <exception cref="InvalidOperationException"><paramref name="bypassValidation"/> is <c>false</c> and <paramref name="carrier"/> may not have connected properties.</exception>
        public static IConnectibleProperty<object> GetConnectedPropertyAsObject<TTag>(this object carrier, string name, bool bypassValidation = false)
        {
            Contract.Requires(carrier != null);
            Contract.Ensures(Contract.Result<IConnectibleProperty<object>>() != null);
        ...
        /// <param name="bypassValidation">Whether to bypass carrier object validation. Defaults to <c>false</c>.</param>
        /// <returns>The connectible property, or <c>null</c> if <paramref name="bypassValidation"/> is <c>false</c> and <paramref name="carrier"/> may not have connected properties.</returns>
        public static IConnectibleProperty<object> TryGetConnectedPropertyAsObject<TTag>(this object carrier, string name, bool bypassValidation = false)
        {
            Contract.Requires(carrier != null);
